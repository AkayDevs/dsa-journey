...
class Solution:
    ...
    """
    def wordLadderLength(self, startWord, targetWord, wordList) -> int:
        ...
        while len(q) > 0:
            ...
            for i in range(wordLen):
                for j in range(26):
                    ...
                    new_word = cur_word[:i] + new_char + cur_word[i + 1:]
                    if new_word in word_set:
                        if new_word == targetWord:
                            return cur_count + 1
                        
                        word_set.discard(new_word)
                        q.append((new_word, cur_count + 1))
...
def main():
    ...
    try:
        ...
        solution = Solution()
        result = solution.wordLadderLength(startWord, targetWord, word_list)
