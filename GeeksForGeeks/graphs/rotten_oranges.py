...
class Solution:
    ...
    def orangesRotting(self, mat) -> int:
        ...
        while not q.empty():
            ...
            for coord in possible_coords:
                new_i = ni + coord[0]
                new_j = nj + coord[1]
                if new_i >= 0 and new_i < n and new_j >= 0 and new_j < m and visited[new_i][new_j] != 1 and mat[new_i][new_j] == 1:
                    visited[new_i][new_j] = 1
                    mat[new_i][new_j] = 2
                    q.put_nowait([new_i, new_j, f + 1])
    ...
    def fasterOrangesRotting(self, mat):
        rq = []
        pos = [(-1, 0), (1, 0), (0, -1), (0, 1)]
...
def main():
    ...
    try:
        ...
        n = read_int()
        m = read_int()
        mat = [read_list_int() for _ in range(n)]
        
        # Create solution object and call the function
        solution = Solution()
        result = solution.orangesRotting(mat)
